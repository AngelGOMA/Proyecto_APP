...
import 'package:fluttermovieapptutorial/menu_lateral.dart';
    ...
    return Scaffold(
      ...
      body: NestedScrollView(
        ...
        body: ListView(children: <Widget>[
          ...
          _buildMoviesListView(popularMovies, 'Populares Actuales'),
          _buildMoviesListView(topRatedMovies, 'Más Votadas'),
        ]),
      ),
      bottomNavigationBar: BottomNavigationBar(
          ...
          items: [
            BottomNavigationBarItem(
                icon: Icon(Icons.local_movies), title: Text('Películas')),
            BottomNavigationBarItem(
